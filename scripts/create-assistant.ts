...
const config = {
  name: "Door Agent",
  firstMessage: "Hi! What's the word of the day? Or if someone knows you're visiting, please say your name.",
  model: {
    provider: "openai",
    model: "gpt-4o",
    messages: [
      {
        ...
        content:
          ...
          "When someone calls, wait for them to give you a word or their name. Don't call verify_identity for greetings or small talk — only when they actually give you something. " +
          "Every time the caller gives you a word or name, you MUST call verify_identity — never skip it, never reuse a previous result. " +
          "If it checks out, press dtmf with digits '1', say 'Come on in.' and end the call. " +
          "If it doesn't, say 'That didn't work — try again.' and wait. Give them another shot. " +
